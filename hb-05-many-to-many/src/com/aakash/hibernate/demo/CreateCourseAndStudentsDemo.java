...
import com.aakash.hibernate.demo.entity.Review;
...
public class CreateCourseAndStudentsDemo {
	...
	public static void main(String[] args) {
		...
		try {			
			...
			// create the students
			Student tempStudent1 = new Student("John", "Doe", "john@lancsccc.com");
			Student tempStudent2 = new Student("Mary", "Public", "mary@lancsccc.com");
